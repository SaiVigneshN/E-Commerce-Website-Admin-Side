...
<?php 
    ...
    if(isset($_GET['edit_p_cat'])){
        ...
        $edit_p_cat_query = "select * from product_categoies where p_cat_id='$edit_p_cat_id'";
...
<?php  
          ...
          if(isset($_POST['update'])){
              ...
              if(is_uploaded_file($_FILES['p_cat_image']['tmp_name'])){
                ...
                $update_p_cat = "update product_categoies set p_cat_title='$p_cat_title',p_cat_top='$p_cat_top',p_cat_image='$p_cat_image' where p_cat_id='$p_cat_id'";
                ...
                $update_p_cat = "update product_categoies set p_cat_title='$p_cat_title',p_cat_top='$p_cat_top' where p_cat_id='$p_cat_id'";
